...
var websResource = schema.GroupVersionResource{Group: "apps.ysicing.cloud", Version: "v1beta1", Resource: "webs"}

var websKind = schema.GroupVersionKind{Group: "apps.ysicing.cloud", Version: "v1beta1", Kind: "Web"}
