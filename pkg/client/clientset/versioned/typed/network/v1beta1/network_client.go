...
// NetworkV1beta1Client is used to interact with features provided by the network.ysicing.me group.
type NetworkV1beta1Client struct {
	restClient rest.Interface
}

func (c *NetworkV1beta1Client) ClusterEndpoints(namespace string) ClusterEndpointInterface {
	return newClusterEndpoints(c, namespace)
}
